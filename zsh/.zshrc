...
plugins=(git sudo history encode64 copypath zsh-autosuggestions zsh-syntax-highlighting gh emacs auto-notify you-should-use asdf docker)
...
load_venv_on_cd  # run once at shell start, too
